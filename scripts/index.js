...
$(document).ready(function () {
  ...
  if (
    url.substring(url.length - 10, url.length) == "index.html" ||
  ...
  if (
    url.substring(url.length - 14, url.length) == "reuniones.html" ||
    url.substring(url.length - 15, url.length) == "reuniones.html#"
  ) {
